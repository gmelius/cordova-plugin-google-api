 ...
 * @author Yaniv Inbar
 */
public class GoogleApiRequest<T> extends GenericData {
     ...
     * @param jsonContent Json of the object that will be sent
     ...
     * </p>
     */
    public GoogleApiRequest<T> setDisableGZipContent(boolean disableGZipContent) {
     ...
     * </p>
     */
    public GoogleApiRequest<T> setRequestHeaders(HttpHeaders headers) {
    ...
    public GenericUrl buildHttpRequestUrl() {
        return new GenericUrl(
                UriTemplate.expand(abstractGoogleClient.getBaseUrl(), uriTemplate, uriParams, true));
    }
    ...
    @Override
    public com.google.api.client.googleapis.services.AbstractGoogleClientRequest<T> set(String fieldName, Object value) {
        return (com.google.api.client.googleapis.services.AbstractGoogleClientRequest<T>) super.set(fieldName, value);
    }
